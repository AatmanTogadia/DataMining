...
def rest_query_ex2():
    query = 'THEFT OR RAPE OR CORRUPTION OR VIOLENCE OR CRIME OR TERROR OR FELONY OR MURDER OR ASSAULT OR ATTACK OR ROBBERY OR HOMICIDE OR BURGLARY OR KIDNAPPING '
    geo = ('40.7305991', '-73.9865811', '450mi') # City of New York
    f = open('500-tweets.txt','w')    
    MAX_ID = None
    print 'aa'
    for it in range(5):
...
def rest_query_ex3(): 
    query = 'THEFT OR RAPE OR CORRUPTION OR VIOLENCE OR CRIME OR TERROR OR FELONY OR MURDER OR ASSAULT OR ROBBERY OR HOMICIDE OR BURGLARY OR KIDNAPPING'
    #f = open('output.txt','w')
    geo = ('40.7305991', '-73.9865811', '450mi') # City of New York
    MAX_ID = None 
